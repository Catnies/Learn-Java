package top.catnies.learn.reflection;
...
public class ReflectionMain {
    ...
    public static void createPrivateClass() throws Exception {
        // 1. 想办法获取对象的Class.
        Class<?> clazz = Class.forName("top.catnies.learn.reflection.PrivateClass");
        // 2. 获取构造函数, 并实例化对象.
    ...
    public static void getPrivateFieldAndMethod() throws Exception {
        ...
        Class<?> clazz_2 = Class.forName("top.catnies.learn.reflection.PrivateClass"); // 使用全类名获取.
